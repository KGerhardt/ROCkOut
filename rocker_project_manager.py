...
class project_manager:
	...
	def parse_genomes(self):
		...
		for base in self.positive:
			...
			if os.path.exists(relevant_directory):
				self.genomes_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.genomes_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
	...
	def parse_gffs(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.gffs_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.gffs_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
	...
	def parse_coords(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.coords_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.coords_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
	...
	def parse_raw_reads(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.read_fastas_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.read_fastas_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
	...
	def parse_tagged_reads(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.tagged_reads_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.tagged_reads_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]				
	...
	def parse_targets(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.targets[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
	...
	def parse_aligns(self):
		...
		for base in self.positive:
			relevant_directory = os.path.normpath(self.positive[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.alignments_pos[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]
		for base in self.negative:
			relevant_directory = os.path.normpath(self.negative[base] + "/" + relevant_name) + "/"
			if os.path.exists(relevant_directory):
				self.alignments_neg[base] = [relevant_directory + c for c in os.listdir(relevant_directory)]		
